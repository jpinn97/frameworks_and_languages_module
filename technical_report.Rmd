...
Middleware is a intermediatary layer that is used to provide modular pre or post processing of data that is incoming/outgoing from an application route, whilst maintaining the core functionality of the routing function.
